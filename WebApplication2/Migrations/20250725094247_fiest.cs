        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGroomed = table.Column<bool>(type: "bit", nullable: false),
                    IsSacrificed = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offers_Animals_AnimalId",
                        column: x => x.AnimalId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stocks_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stocks_AspNetUsers_AddedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocks_AddedById",
                table: "Stocks",
                column: "AddedById");

            migrationBuilder.CreateIndex(
                name: "IX_Stocks_AnimalId",
                table: "Stocks",
                column: "AnimalId");

            migrationBuilder.CreateIndex(
                name: "IX_UserOtps_UserId_OtpCode_Purpose",
                table: "UserOtps",
                columns: new[] { "UserId", "OtpCode", "Purpose" });
        }
